...
class BitMix
{
    ...
    private $apiKey = null, $apiKeyId = 0;
     ...
     * @return BitMix
     */
    public function setApiKeyId(int $apiKeyId): BitMix
    {
    ...
    public function createOrder(): Order
    {
        ...
        if ($this->getApiKeyId() > 0) {
            if (\is_null($this->getApiKey()))
                throw new Exception('API key not set!');

            $data['shop_id'] = $this->getApiKeyId(); // TODO: $data['api_key_id'] = $this->getApiKeyId();
...
$mixer = new \BitMix\BitMix('bitcoin', '123456789012');
